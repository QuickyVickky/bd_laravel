          ...
          <div class="statbox widget box box-shadow">
            <div class="widget-header">
              <div class="row" style="align-items: center;">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                  <a class="btn btn-info m-2 btn-rounded float-right" onClick="show_add_newsalesexecutiveModal()"> Add {{ $control }}</a>
                  </div>
...
<script type="text/javascript" >
    ...
    url: "{{ route('get-sales-executive-list') }}" ,
	type: "get" 
	},
    aoColumnDefs: 
	[{ 
...
$('body').on('click', '.editit', function () {
	 ...
	 show_add_newsalesexecutiveModal(idx);
});
...
@include('admin.salesexecutive.add') 
</body>
</html>