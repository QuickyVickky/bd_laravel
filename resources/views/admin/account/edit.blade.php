      ...
      <div class="row layout-top-spacing">
        <div class="col-lg-12 col-12 layout-spacing">
          <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area"> @if(count($one)>0)
              <form method="post" action="{{ route('submit-account-update') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                  <div class="col-sm-2">
                    <div class="form-group required">
                      ...
                      <input type="text" name="account_datetime" class="form-control datepicker" id="account_datetime" placeholder="Required" value="{{ @$one[0]->account_datetime }}">
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group required">
                      <label for="name">Amount ( required )</label>
                      <input type="text" name="amount" class="form-control showcls24mec allowdecimal" id="amount" placeholder="Amount Rs" value="{{ @$one[0]->amount }}" required maxlength="10" >
                    </div>
                  </div>
                 ...
                 @foreach($account_type as $row)
                        ...
                        <?php
							$selected = '';
							if($row->short==@$one[0]->type){ $selected = "selected" ;}
							?>
                 ...
                 @endforeach
                  ...
                  <div class="col-sm-2">
                    <div class="form-group required">
                      ...
                      <input type="text" name="anybillno" class="form-control showcls24mec" id="anybillno" placeholder="Bill No" value="{{ @$one[0]->anybillno }}" maxlength="24" >
                    </div>
                  </div>
                  <input type="hidden" name="is_active" id="is_active" value="{{ @$one[0]->is_active }}"  >
                  <div class="col-sm-10">
                    <input type="hidden" name="existing_img" id="existing_img" value="{{ @$one[0]->anybillno_document }}" >
                    <div class="form-group  required">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group  required">
                      ...
                      <input type="text" name="comments" class="form-control showcls24mec" id="comments" placeholder="Any Details" value="{{ @$one[0]->comments }}">
                    </div>
                  </div>
                </div>
                <hr style="width:100%">
...
<script type="text/javascript" >
  ...
  var includeid = "{{ isset($one[0]->account_subcategory_id) ? $one[0]->account_subcategory_id : 0 }}";
