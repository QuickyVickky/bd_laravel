            ...
            <div class="widget-header">
              ...
              @if(Session::get("msg")!='')
                  <div class="alert alert-{{ Session::get("cls") }} mb-4" role="alert">
                    ...
                    {{ Session::get("msg") }} </div>
                  @endif  </div>
                <div class="col-xl-6 col-md-6 col-sm-6 col-6"> <a href="{{ route('subscription-purchase-add') }}" class="btn btn-info m-2 btn-rounded float-right"> Add Subscription Purchase Manually</a> </div>
              </div>
            </div>
...
<script type="text/javascript" >
	...
	$(document).ready(function () {
	   ...
	   t1 = $('#t1').DataTable({
		...
		ajax:  { 
		data: {"testonly": 1 },
		url: "{{ route('get-subscription-purchase-list') }}" ,
		type: "get" 
		},
		aoColumnDefs: 
		[{ 
