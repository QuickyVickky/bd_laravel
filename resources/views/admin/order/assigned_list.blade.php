...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                        <a class="btn btn-warning m-2 btn-rounded float-right" href="javascript:void(0)"
                                            onClick="assignMultiple()"> Assign</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                ...
                                <table id="t1" class="table table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th width="5%">BigDaddy LR Number <input type="checkbox" id="selectAllid" onClick="selectAll(this)"></th>
    ...
    $(document).ready(function() {
		t1 = $('#t1').DataTable({
            ...
            ajax: {
                ...
                url: "{{ route('get-order-list-assigned') }}",
                type: "get"
            },
            aoColumnDefs: [{
                'bSortable': false,
    ...
    function deliverMultiple() {
        var ckd = [];
        $.each($("input[name='selectlist[]']:checked"), function() {
            ckd.push($(this).data('id'));
        });
        ckdlength = ckd.length;
