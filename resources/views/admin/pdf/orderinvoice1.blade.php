        ...
        <div style="position: relative;">
          <table style="text-align: center;border-top:1px solid black;border-bottom:1px solid black; font-size: 11px; width: 100%;">
            ...
            <tr>
              ...
              <td>{{ @$o['bigdaddy_lr_number'] }}</td>
              <td style="text-transform: uppercase;">{{ @$o['driver']['vehicle_number'] }}</td>
            ...
            @endforeach
            @php 
            if(trim($o['transporter_name'])!='') {
              $tranporter_name_all[] = trim($o['transporter_name']); 
                $tranporter_name_all[] = trim($o['transporter_name_drop']); 
             }
            @endphp
            @endforeach
            <tfoot>
              <tr>
                <th colspan="7" style="border-top:1px solid black;text-align: right;">Total Charges</th>
